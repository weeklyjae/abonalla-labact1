...
<div class="mx-auto max-w-4xl px-4 sm:px-6 py-16">
    <h1 class="text-2xl font-bold mb-6">Submit a Post (Static)</h1>
    <form action="#" method="post" class="space-y-4">
        ...
        <button type="button" class="inline-flex items-center justify-center rounded-md bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">Submit</button>
    </form>
</div>
@endsection
